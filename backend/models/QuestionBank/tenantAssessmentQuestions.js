...
const TenantAssessmentQuestionsSchema = new mongoose.Schema(
  {
    ...
    tenantListId: [
      { type: mongoose.Schema.Types.ObjectId, ref: "TenantQuestionsListNames" },
    ],
...
const TenantAssessmentQuestions =
  mongoose.models.tenantAssessmentQuestions ||
  mongoose.model("tenantAssessmentQuestions", TenantAssessmentQuestionsSchema);
