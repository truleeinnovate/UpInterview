// v1.0.0 - Ashok - Uncommented toAddress, ccAddress, phoneNumber fields in Notification schema
...
const NotificationSchema = new mongoose.Schema(
  {
    ...
    object: {
      // Changed objectName to an object field
      objectName: String,
      objectId: String,
    },
    status: String,
  ...
  { timestamps: true }
); //by using timestamps we can automatically add createdAt and updatedAt fields
