...
// import PermissionDebug from "./Components/PermissionDebug.jsx";
...
//   console.log('🛣️ MainAppRoutes render:', {
//     location: location.pathname,
//     organization,
//     sessionExpired
//   });

//   // Debug permission checks for routes
//   const debugRoutePermissions = () => {
...
//     console.log('🔍 Route permission checks:');
//     routePermissions.forEach(permission => {
//       const hasPermissionResult = hasPermission(permission);
//       console.log(`  ${permission}: ${hasPermissionResult ? '✅' : '❌'}`);
//     });
//   };

//   // Debug on mount and when location changes
//   useEffect(() => {
//     console.log('🔄 Route permissions changed, debugging...');
...
//   // Debug specific route permissions
//   const candidatesRoutePermission = hasPermission("Candidates");
//   const positionsRoutePermission = hasPermission("Positions");
//   const interviewsRoutePermission = hasPermission("Interviews");
//   const mockInterviewsRoutePermission = hasPermission("MockInterviews");
//   const assessmentsRoutePermission = hasPermission("Assessments");

//   console.log('🎯 Route permission results:', {
//     candidatesRoutePermission,
//     positionsRoutePermission,
//     interviewsRoutePermission,
//     mockInterviewsRoutePermission,
//     assessmentsRoutePermission,
//     showLogo,
//     isSuperAdminRoute,
//     shouldRenderNavbar
//   });
