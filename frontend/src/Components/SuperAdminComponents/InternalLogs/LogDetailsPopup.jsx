    ...
    <div className="fixed inset-0 z-50 flex justify-end">
      ...
      <div 
        className={`relative bg-white shadow-xl overflow-hidden transition-all duration-300 max-w-full ${
          isExpanded ? 'w-full' : 'w-full sm:w-3/4 lg:w-1/2'
        }`}
      >
        ...
        <div className="overflow-y-auto h-[calc(100vh-5rem)] p-4 sm:p-6">
              ...
              <div className="bg-white rounded-lg border border-gray-200 p-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center">
                    ...
                    <span className="text-sm font-medium">{log.serverName}</span>
                  </div>
                </div>
              </div>

              <div className="bg-white rounded-lg border border-gray-200 p-4">
                <h3 className="text-sm font-medium text-gray-500 mb-3">Process Information</h3>
                <div className="space-y-2">
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center">
                  ...
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center">
                    ...
                    <span className="text-sm font-medium">{log.executionTime}</span>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="bg-white rounded-lg border border-gray-200 p-4">
                ...
                <div className="space-y-2">
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center">
                    ...
                    <span className="text-sm font-medium break-all">{log.requestEndPoint}</span>
                  </div>
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center">
                    <span className="text-sm text-gray-600">Method:</span>
                    <span className="text-sm font-medium">{log.requestMethod}</span>
                  </div>
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center">
                    <span className="text-sm text-gray-600">Response Code:</span>
                    <span className="text-sm font-medium">{log.responseStatusCode}</span>
                  </div>
                </div>
              </div>
          ...
          <div className="mt-6 space-y-4">
            ...
            {log.requestBody && (
              <div className="bg-white rounded-lg border border-gray-200 p-4">
                <h3 className="text-sm font-medium text-gray-500 mb-3">Request Body</h3>
            ...
            {log.responseBody && (
              <div className="bg-white rounded-lg border border-gray-200 p-4">
                <h3 className="text-sm font-medium text-gray-500 mb-3">Response Body</h3>
                <pre className="text-sm bg-gray-50 p-4 rounded-lg overflow-x-auto">
            ...
            {log.responseError && (
              <div className="bg-white rounded-lg border border-gray-200 p-4">
                ...
                {log.responseMessage && (
                  <p className="mt-2 text-sm text-gray-600">{log.responseMessage}</p>
                )}
              </div>
            )}
          </div>
