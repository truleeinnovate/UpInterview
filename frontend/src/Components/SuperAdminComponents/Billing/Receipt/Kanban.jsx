            ...
            {receipts?.length === 0 ? (
              <div className="col-span-full flex flex-col items-center justify-center py-16 text-gray-500">
                ...
                <p className="text-gray-500 text-center max-w-md">
                  There are no receipts to display at the moment. Create a new
              ...
              receipts?.map((receipt, index) => (
                <motion.div
                  ...
                  whileHover={{ y: -5 }}
                  onClick={() =>
                    navigate(`/receipt/view-details/${receipt._id}`, {
                  ...
                  <div className="flex items-start justify-between mb-2">
                    <div className="flex items-center">
                      ...
                      <div>
                        <h4 className="text-sm font-medium text-custom-blue">
                          {/* {receipt?.interviewerNo || "N/A"} */}
                          receipt #{receipt?._id?.slice(-5, -1) || "N/A"}
                        </h4>
                      </div>
                    </div>
                    <div className="flex items-center gap-1">
                      ...
                      <motion.button
                        ...
                        onClick={(e) => {
                          e.stopPropagation();
                          navigate(`/receipt/edit-receipt/${receipt._id}`);
                        }}
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <div className="flex items-center gap-1.5 text-gray-600">
                        ...
                        {formatCreatedDate(receipt?.createdAt) || "N/A"}
                      </div>
                      <div className="flex items-center gap-1.5 text-gray-600">
                        <MapPin className="w-4 h-4 text-red-500" />
                        <span>{receipt?.transactionId || "Not disclosed"}</span>
                      </div>
                    </div>
                  </div>
                </motion.div>
