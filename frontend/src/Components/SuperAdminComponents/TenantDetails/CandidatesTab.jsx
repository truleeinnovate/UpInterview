  ...
  const [candidates] = useState([
    {
      ...
      notes:
        "Strong frontend expertise with modern frameworks. Good communication skills.",
    },
    {
      id: 2,
      name: "Michael Chen",
    ...
    },
    {
      ...
      notes:
        "Outstanding candidate with strong product vision and leadership experience.",
    },
  ]);
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white px-4 py-2 rounded-lg shadow-sm border border-gray-200">
          ...
          <div className="text-xl font-semibold">
            {
              candidates.filter((c) =>
                ["screening", "assessment", "interview"].includes(c.stage)
              ).length
            }
          </div>
        </div>
