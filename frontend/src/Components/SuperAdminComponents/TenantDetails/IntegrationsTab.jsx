    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          ...
          <p className="text-sm text-gray-600 mb-4">Connected to Google Calendar</p>
          <div className="space-y-2">
            <div className="flex justify-between text-sm">
              <span className="text-gray-500">Last Sync</span>
      ...
      <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <div key={webhook.id} className="border border-gray-200 rounded-lg p-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center text-sm">
                  ...
                  <span className="text-gray-900 font-mono">{webhook.endpoint}</span>
                </div>
                <div className="flex items-center text-sm">
        ...
        <div className="mt-4 p-4 bg-gray-50 rounded-lg">
          <h4 className="text-sm font-medium text-gray-900 mb-2">Webhook Events</h4>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2">
            <div className="flex items-center space-x-2">
              <input type="checkbox" id="interview_completed" className="rounded text-primary-600" />
              <label htmlFor="interview_completed" className="text-sm text-gray-700">Interview Completed</label>
            </div>
            <div className="flex items-center space-x-2">
              <input type="checkbox" id="assessment_submitted" className="rounded text-primary-600" />
              <label htmlFor="assessment_submitted" className="text-sm text-gray-700">Assessment Submitted</label>
            </div>
            <div className="flex items-center space-x-2">
              <input type="checkbox" id="candidate_status" className="rounded text-primary-600" />
              <label htmlFor="candidate_status" className="text-sm text-gray-700">Candidate Status Changed</label>
            </div>
            <div className="flex items-center space-x-2">
              <input type="checkbox" id="user_created" className="rounded text-primary-600" />
              <label htmlFor="user_created" className="text-sm text-gray-700">User Created</label>
            </div>
            <div className="flex items-center space-x-2">
              <input type="checkbox" id="position_updated" className="rounded text-primary-600" />
              <label htmlFor="position_updated" className="text-sm text-gray-700">Position Updated</label>
            </div>
          </div>
        </div>
      </div>
