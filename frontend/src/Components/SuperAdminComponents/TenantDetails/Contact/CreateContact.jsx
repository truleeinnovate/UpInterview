...
import { validateContactForm, getContactErrorMessage } from '../../../../utils/ContactValidation';
...
const CreateContact = ({ onContactAdded, onContactUpdated }) => {
  ...
  const toggleFullWidth = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            if (editMode) {
                const response = await axios.patch(`${process.env.REACT_APP_API_URL}/contact/${formData.id}`, formData);
          ...
          >
            ...
            <div className="bg-custom-blue text-white border-b">
              <div className="flex justify-between items-center p-4">
                <button onClick={() => navigate('/contacts')} className="focus:outline-none md:hidden lg:hidden xl:hidden 2xl:hidden sm:w-8">
                  <IoArrowBack className="text-2xl" />
                </button>
                <h2 className="text-lg font-medium">{editMode ? "Edit Contact" : "New Contact"}</h2>
                <div className="flex items-center gap-2">
                  ...
                  <button onClick={() => navigate('/contacts')} className="focus:outline-none sm:hidden">
