...
export const useTenants = () => {
  ...
  const tenantPermissions = sharingPermissionscontext?.candidate || {};

  const { data: tenantsData = [], loading } = useQuery({
    queryKey: ["tenants", tenantPermissions],
  ...
  return { tenantsData, loading, addOrUpdateCandidate };
};
