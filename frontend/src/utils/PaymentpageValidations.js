...
export const validateCardFields = (setErrors, formData) => {
    ...
    if (!/^(0[1-9]|1[0-2])\/\d{2}$/.test(formData.cardexpiry)) newErrors.cardexpiry = "Expiry must be in MM/YY format.";
...
export const handlePaymentInputChange = (target, paymentData, setPaymentData, setErrors, errors) => {
...
export const paymentMethods = [
    ...
    {
        name: 'UPI',
        imgSrc: 'https://t3.ftcdn.net/jpg/05/60/50/16/240_F_560501607_x7crxqBWbmbgK2k8zOL0gICbIbK9hP6y.jpg',
    },
    {
        name: 'Net Banking',
