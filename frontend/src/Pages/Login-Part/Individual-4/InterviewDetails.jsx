...
const InterviewDetails = ({
  ...
  useEffect(() => {
    ...
    if (
      interviewDetailsData.PreviousExperienceConductingInterviews === undefined
    ) {
      setInterviewDetailsData((prev) => ({
        ...prev,
    ...
    if (
      interviewDetailsData?.skills?.length > 0 &&
  ...
  // useEffect(() => {
  //   if (rateCards.length > 0 && additionalDetailsData?.currentRole) {
  ...
  //     }));
  //   }
  // }, [rateCards, additionalDetailsData?.currentRole]);
  ...
  const handleRadioChange = (e) => {
    ...
    setInterviewDetailsData((prev) => ({
      ...
      previousInterviewExperienceYears:
        value === "no" ? "" : prev.previousInterviewExperienceYears,
    }));
    setErrors((prev) => ({
      ...prev,
      previousInterviewExperience: "",
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="text-xs text-gray-600 mb-4">
              {isRateLoading ? (
                ...
                <span>
                  Approximately 1 USD = {Number(exchangeRate).toFixed(2)} INR
                </span>
              )}
            </div>
          </div>
                      ...
                      <div className="w-1/2 sm:w-full pl-2 sm:pl-0">
                        ...
                        <div className="relative">
                          <input
                            ...
                            id={`${level.key}_inr`}
                            value={
                              interviewDetailsData.rates?.[level.key]?.inr || ""
                            }
