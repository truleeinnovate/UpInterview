    ...
    const handleNextStep = async () => {
        try {
            ...
            if (currentStep === 0) {
                ...
                // const showJuniorLevel = expYears > 0 && expYears <= 3;
                // const showMidLevel = expYears > 3 && expYears <= 6;
