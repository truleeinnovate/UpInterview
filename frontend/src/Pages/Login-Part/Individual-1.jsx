    ...
    return (
        <Layout>
            <div className="min-h-screen bg-gray-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-4 md:px-6 lg:px-8 xl:px-8 2xl:px-8 py-8 sm:py-10 md:py-12 lg:py-12 xl:py-12 2xl:py-12">
                    {/* Hero Section */}
                    <div className="text-center mb-12 sm:mb-16 md:mb-20 lg:mb-20 xl:mb-20 2xl:mb-20">
                        <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-3xl xl:text-4xl 2xl:text-4xl font-bold text-gray-900 mb-6 sm:mb-8 md:mb-8 lg:mb-8 xl:mb-8 2xl:mb-8 leading-tight">
                            Accelerate Your{' '}
                            <span className="text-custom-blue">Interview Process</span>
                        </h1>
                        <p className="text-sm sm:text-md md:text-lg lg:text-lg xl:text-lg 2xl:text-lg text-gray-600 max-w-3xl sm:max-w-3xl md:max-w-4xl lg:max-w-4xl xl:max-w-4xl 2xl:max-w-4xl mx-auto mb-8 sm:mb-10 md:mb-12 lg:mb-12 xl:mb-12 2xl:mb-12 leading-relaxed">
                    ...
                    <div className="grid sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 2xl:grid-cols-2 gap-8 sm:gap-10 md:gap-12 lg:gap-12 xl:gap-12 2xl:gap-12 max-w-6xl mx-auto mb-12 sm:mb-16 md:mb-20 lg:mb-20 xl:mb-20 2xl:mb-20">
                        <div className="bg-white rounded-xl p-6 sm:p-8 md:p-8 lg:p-8 xl:p-8 2xl:p-8 shadow-lg border-l-4 border-custom-blue hover:shadow-2xl transition-all duration-300">
                            ...
                            <p className="text-md text-gray-600 mb-6 sm:mb-8 md:mb-8 lg:mb-8 xl:mb-8 2xl:mb-8 leading-relaxed">
                                ...
                                expertise by conducting technical interviews for leading companies.
