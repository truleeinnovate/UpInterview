            ...
            <div className="relative z-10 flex flex-col justify-center px-4 lg:px-8 py-8 lg:py-12 text-white animate-fade-in">
              <div className="mb-8">
                <div className="inline-flex items-center bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 mb-6">
                  ...
                  <span className="text-sm font-medium">500+ Active Interviewers Online</span>
                </div>
                ...
                <p className="text-xl text-white/90 leading-relaxed mb-2">
                  Connect with leading companies and monetize your technical expertise.
                  Conduct professional interviews on your schedule.
                </p>
              ...
              <div className="grid grid-cols-2 gap-3 mb-6">
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 text-center hover:bg-white/15 transition-all duration-300 group">
                  <div className="text-2xl font-bold group-hover:scale-110 transition-transform duration-300">$75-150</div>
              ...
              <div className="space-y-3 mb-6">
                <div className="flex items-center group">
                  ...
                  <div>
                    ...
                    <p className="text-white/80 text-sm">Set your own availability and work when you want</p>
                  </div>
                </div>
                ...
                <div className="flex items-center group">
                  ...
                  <div>
                    <h4 className="font-semibold text-lg">Premium Compensation</h4>
                    <p className="text-white/80 text-sm">Earn competitive rates for your expertise</p>
                  </div>
                </div>
                ...
                <div className="flex items-center group">
                  ...
                  <div>
                    ...
                    <p className="text-white/80 text-sm">Work with leading tech companies and startups</p>
                  </div>
                </div>
              </div>
              ...
              {/* Company Logos */}
              <div className="mb-4">
                <p className="text-sm text-white/60 mb-4">Trusted by interviewers from:</p>
          ...
          <div className="w-full lg:w-1/2 xl:w-1/2 2xl:w-1/2 flex items-start justify-center p-6 lg:p-12 bg-gradient-to-br from-gray-50 to-white pt-8">
            <div className="max-w-lg w-full">
              <div className="bg-white rounded-2xl shadow-2xl p-6 border border-gray-100 hover:shadow-3xl transition-all duration-300">
                ...
                <button
                  onClick={handleLinkedInLogin}
                  className="w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-medium py-3 px-6 rounded-xl transition-all duration-300 flex items-center justify-center mb-4 shadow-lg hover:shadow-xl transform hover:scale-105"
                >
              ...
              <div className="mt-6 text-center">
                <div className="inline-flex items-center bg-white rounded-lg px-4 py-2 shadow-sm border border-gray-200 hover:shadow-md transition-all duration-300">
                  ...
                  <span className="text-xs text-gray-600 font-medium">🛡️ Secure & Verified Platform</span>
                </div>
              </div>
            </div>
          </div>
