                        ...
                        <div key={column.id} className="space-y-3">
                            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-sm text-gray-500">
                                        ({contacts.filter(c => (c.status?.toLowerCase() || 'new') === column.id).length})
                                    </span>
                                </div>
                            </div>
                            ...
                            {columnContacts.length > 0 ? (
                                    ...
                                    >
                                        ...
                                        <div className="space-y-2 mb-3">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <div>
                                                    <p className="font-medium text-sm">{contact.contactPerson || 'N/A'}</p>
                                                    <p className="text-xs text-gray-500">{contact.companyName || 'N/A'}</p>
                                                </div>
                                            </div>
                                        ...
                                        <div className="flex items-center justify-between pt-3 border-t border-gray-100">
                                            ...
                                            <div className="flex gap-1">
                                                ...
                                                {contact.status !== 'contacted' && permissions?.Update && (
                                                    <button
                                                ...
                                                {contact.status !== 'qualified' && contact.status !== 'closed' && permissions?.Update && (
                                                    <button
                                ...
                                <div className="border-2 border-dashed border-gray-200 rounded-lg p-6 text-center">
                                    ...
                                    <p className="text-sm text-gray-500">No contacts in this status</p>
                                </div>
                            )}
                        </div>
                    );
