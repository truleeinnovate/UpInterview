  ...
  return (
    <div className="px-8 py-6 bg-gray-50/50 rounded-b-2xl flex justify-between items-center">
      <button
        ...
        className={`inline-flex items-center sm:px-3 px-4 py-2 rounded-lg text-sm font-medium transition-all duration-300 ${
          currentQuestionIndex === 0
            ? "bg-gray-100 text-gray-400 cursor-not-allowed"
            : "bg-white text-gray-700 hover:bg-gray-50 border border-gray-200 hover:border-gray-300"
        }`}
      >
        <ChevronLeftIcon className="sm:h-4 sm:w-4 h-4 w-4 mr-2" />
        Previous
      </button>
      <button
        onClick={() => {
      ...
      >
        Next
        <ChevronRightIcon className="sm:h-4 sm:w-4 h-4 w-4 ml-2" />
      </button>
    </div>
  );
  // v1.0.1 ----------------------------------------------------------------------------->
