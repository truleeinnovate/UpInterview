    ...
    return (
        <div className="px-8 py-6 bg-gray-50/50 rounded-b-2xl flex justify-between items-center">
            <button
                ...
                className={`inline-flex items-center px-6 py-2 rounded-xl text-lg font-medium transition-all duration-300 ${currentQuestionIndex === 0
            ...
            <button
                ...
                className={`inline-flex items-center px-6 py-2 rounded-xl text-lg font-medium transition-all duration-300 ${currentQuestionIndex === currentSectionData?.questions?.length - 1 && currentSection === questions?.sections?.length - 1
                    ? 'bg-gray-100 text-gray-400 cursor-not-allowed'
                    : 'bg-white text-gray-700 hover:bg-gray-50 border border-gray-200 hover:border-gray-300'
                    }`}
            >
