                        ...
                        <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 transform transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                            ...
                            <div className="grid grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <p className="text-lg font-medium text-gray-900">{candidate?.FirstName} {candidate?.LastName}</p>
                                </div>
                                <div>
                                    <p className="text-sm font-medium text-gray-500">Email</p>
                                    <p className="text-lg font-medium text-gray-900">{candidate?.Email}</p>
                                </div>
                                <div>
                                    <p className="text-sm font-medium text-gray-500">Phone</p>
                                    <p className="text-lg font-medium text-gray-900">{candidate?.Phone}</p>
                                </div>
                                <div>
                                    <p className="text-sm font-medium text-gray-500">Position</p>
                                    <p className="text-lg font-medium text-gray-900">{assessment?.assessmentId?.Position}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 transform transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                            ...
                            <div className="space-y-4">
                                {assessmentQuestions?.sections ? (
                                    <>
                                        {console.log('Sections data:', assessmentQuestions.sections)}
                                        {assessmentQuestions.sections.map((section, index) => (
                                            ...
                                            >
                                                ...
                                                <p className="text-base text-gray-600 mt-2">Pass Score: {section.passScore}{section.passScoreType === "Percentage" ? '%' : ''}</p>
                                            </div>
                                        ))}
                                    </>
                                ) : (
