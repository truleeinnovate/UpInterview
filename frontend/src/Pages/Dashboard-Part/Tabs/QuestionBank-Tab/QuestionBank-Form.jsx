...
useEffect(() => {
  ...
  const handleSubmit = async (e, isSaveAndNext) => {
    ...
    try {
      ...
      if (!isSaveAndNext && listRef.current && typeof listRef.current.clearSelection === "function") {
                    ...
                    {selectedQuestionType === 'Boolean' ? (
                      <div className="relative">
                        <input
                          ...
                          readOnly
                          className={`w-full px-3 py-2 border sm:text-sm rounded-md border-gray-300 cursor-pointer ${errors.correctAnswer
                            ? "border-red-500"
                            : "border-gray-300 focus:border-black"
                            }`}
                        />
                        <div className="absolute inset-y-0 right-3 flex items-center cursor-pointer text-gray-500">
                          <MdArrowDropDown className="absolute top-3 text-gray-500 text-lg mt-1 cursor-pointer right-1" onClick={toggleDropdownBooleanAnswer} />
                        </div>
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        className={`w-full px-3 py-2 border sm:text-sm rounded-md border-gray-300 ${errors.correctAnswer
                          ? "border-red-500"
                          : "border-gray-300 focus:border-black"
                          }`}
                      />
