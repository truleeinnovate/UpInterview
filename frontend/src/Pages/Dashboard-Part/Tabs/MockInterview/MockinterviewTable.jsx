                        ...
                        <td className="px-6 py-1 whitespace-nowrap">
                          <div className="flex items-center">
                            ...
                            <div className="py-2 px-2 flex items-center gap-3"
                              onClick={() => navigate(`/mock-interviews-details/${mockinterview._id}`, { state: { from: location.pathname } })}>
                            ...
                            {openMenuIndex === index && (
                              ...
                              >
                                ...
                                <Menu.Item>
                                  {({ active }) => (
                                    <button
                                      onClick={() => navigate(`/mock-interviews/${mockinterview._id}/edit`, { state: { from: location.pathname } })}
                                      className={`${active ? 'bg-gray-50' : ''
                                        } flex items-center gap-2 w-full px-4 py-2 text-sm text-gray-700`}
                                    >
