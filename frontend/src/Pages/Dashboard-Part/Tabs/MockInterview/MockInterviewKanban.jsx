            ...
            >
              <div className="flex justify-between items-start mb-3">
                ...
                >
                  ...
                  >
                    {mockinterview?.rounds?.[0]?.roundTitle || mockinterview?.title || 'Untitled Interview'}
                  </h4>
                </motion.div>
              ...
              <div className="space-y-2 text-xs mt-2">
                <div className="grid grid-cols-2 gap-2">
                  ...
                  >
                    ...
                    <div className="text-gray-700">{mockinterview?.technology || mockinterview?.rounds?.[0]?.technology || "N/A"}</div>
                  </motion.div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  >
                    ...
                    <span className="text-gray-700">{mockinterview?.interviewer || mockinterview?.rounds?.[0]?.interviewer || "N/A"}</span>
                  </motion.div>
                  ...
                  >
                    ...
                    <span className="text-gray-700">{mockinterview?.createdAt ? new Date(mockinterview.createdAt).toLocaleDateString() : "N/A"}</span>
                  </motion.div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  >
                    ...
                    <span className="text-gray-700">{mockinterview?.duration || mockinterview?.rounds?.[0]?.duration || "N/A"} {mockinterview?.duration || mockinterview?.rounds?.[0]?.duration ? 'mins' : ''}</span>
                  </motion.div>
                  <div></div>
                </div>
              </div>
