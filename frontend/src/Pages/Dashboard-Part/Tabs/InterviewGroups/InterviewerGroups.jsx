...
//         <span className="font-semibold text-teal-700">My Teams</span>{" "}
//         allows you to organize interviewers into functional groups
//         based on departments, projects, or hiring needs. Teams provide
//         a higher-level organization structure, making it easy to
//         assign interview responsibilities to entire groups and track
//         team-based metrics. Use teams alongside{" "}
//         <span className="font-semibold">Interviewer Tags</span> for
//         maximum flexibility in matching interviewers to specific
//         interview rounds.
//       </p>
//     </>,
//   ]}
...
//           <Header
//             title="My Teams"
//             onAddClick={() => navigate(`/my-teams/team-form`)}
        ...
        <InfoGuide
          ...
          items={[
            <>
              <p className="text-sm text-gray-700">
                <span className="font-semibold text-teal-700">My Teams</span>{" "}
                allows you to organize interviewers into functional groups based
                on departments, projects, or hiring needs. Teams provide a
                higher-level organization structure, making it easy to assign
                interview responsibilities to entire groups and track team-based
                metrics. Use teams alongside{" "}
                <span className="font-semibold">Interviewer Tags</span> for
                maximum flexibility in matching interviewers to specific
                interview rounds.
              </p>
        ...
        >
          <div className="p-4 space-y-4">
            ...
            {["active", "inactive"].map((status) => (
              <label
                key={status}
                className="flex gap-2 text-sm cursor-pointer hover:text-custom-blue items-center"
              >
                <input
                  type="checkbox"
