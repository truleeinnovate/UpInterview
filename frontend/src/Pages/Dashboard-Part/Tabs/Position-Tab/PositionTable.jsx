          ...
          <div className={`${isMenuOpen ? 'overflow-x-auto' : ""} rounded-xl`} >
            <table className="w-full">
              ...
              <thead className="border-b">
                <tr>
                  <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider w-64 bg-gray-50 rounded-tl-xl">
                    Title
                  </th>
                  <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer bg-gray-50">
                    Company Name
                  </th>
                  ...
                  <th className="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider bg-gray-50 rounded-tr-xl">
                    Action
                  </th>
                </tr>
              </thead>
              {/* Table body */}
              <tbody className={`divide-y divide-gray-200 ${positions.length > 0 ? 'border-b' : ''}`}>
                {positions.length === 0 ? (
                  <tr>
