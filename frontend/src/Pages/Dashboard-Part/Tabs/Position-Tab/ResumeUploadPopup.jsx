...
export default function ResumeUploadPopup({ positionId, positionTitle, onClose }) {
                    ...
                    <div className="bg-white border border-gray-200 rounded-xl overflow-hidden">
                        ...
                        <div className="p-5">
                            <div className="grid sm:grid-cols-1 grid-cols-2 gap-4">
                                <div
                                    className={`relative p-5 rounded-xl border-2 cursor-pointer transition-all ${screeningMethod === 'ai_claude'
                                ...
                                >
                                    ...
                                    <h4 className="font-semibold text-gray-900 mb-1">AI Screening (Claude)</h4>
                                    <p className="text-sm text-gray-500">Advanced AI analysis with deep understanding of skills, experience, and cultural fit</p>
                                    <div className="mt-3 flex flex-wrap gap-1">
                                        <span className="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-purple-100 text-purple-700">Smart Matching</span>
                                        <span className="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-purple-100 text-purple-700">Skill Extraction</span>
                                    </div>
                                </div>

                                <div
                                    className={`relative p-5 rounded-xl border-2 cursor-pointer transition-all ${screeningMethod === 'system_internal'
                                        ? 'border-blue-500 bg-blue-50 shadow-lg shadow-blue-500/10'
                                        : 'border-gray-200 hover:border-gray-300 hover:shadow-md'
                                        }`}
                                    onClick={() => setScreeningMethod('system_internal')}
                                >
                                    {screeningMethod === 'system_internal' && (
                                        <div className="absolute top-3 right-3">
                                    ...
                                    <h4 className="font-semibold text-gray-900 mb-1">System Screening</h4>
                                    <p className="text-sm text-gray-500">Fast keyword-based matching using your predefined criteria and requirements</p>
                                    <div className="mt-3 flex flex-wrap gap-1">
                                        <span className="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-blue-100 text-blue-700">Fast Processing</span>
                                        <span className="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-blue-100 text-blue-700">Rule Based</span>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            {currentStep === 2 && (
                <div className="bg-white border border-gray-200 rounded-xl overflow-hidden">
                    {isProcessing ? (
                            ...
                            <div className="bg-gradient-to-r from-purple-600 to-indigo-600 p-6 text-white">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-white/80 text-sm">Analyzing resumes with advanced AI</p>
                                    </div>
                                </div>
                            </div>
                            <div className="p-8">
                        ...
                        <>
                            <div className="bg-gradient-to-r from-custom-blue to-teal-500 p-6 text-white">
                                <div className="flex items-center gap-3">
                                    <div className="w-12 h-12 rounded-xl bg-white/20 flex items-center justify-center">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-white/80 text-sm">Review your settings before processing</p>
                                    </div>
                                </div>
                            </div>
                            <div className="p-8">
                    ...
                    <div className="flex sm:flex-col flex-row gap-4">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <select
                                ...
                                className="px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-custom-blue focus:border-custom-blue"
                            >
