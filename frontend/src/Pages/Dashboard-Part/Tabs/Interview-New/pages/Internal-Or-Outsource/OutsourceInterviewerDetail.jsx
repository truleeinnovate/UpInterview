    ...
    <div className="mt-4">
      <div className="flex justify-between items-center mb-4">
        <Button variant="ghost" size="sm" onClick={previousWeek}>
          ...
          <span className="sm:hidden md:hidden inline">Previous Week</span>
        </Button>
        <h4 className="text-sm font-medium text-gray-900">
          {formatDate(weekDates[0])} - {formatDate(weekDates[6])}
        </h4>
        <Button variant="ghost" size="sm" onClick={nextWeek}>
          <span className="sm:hidden md:hidden inline">Next Week</span>
...
function InterviewerDetailsModal({ interviewer, onClose }) {
          ...
          <div key="about" className="space-y-4 mb-5">
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm">
                {capitalizeFirstLetter(interviewer.contact.bio) ||
                  "No biography or introduction available."}
              </p>
            </div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-sm font-medium text-custom-blue">
                        {capitalizeFirstLetter(interviewer.contact.firstName)}{" "}
                        {capitalizeFirstLetter(interviewer.contact.lastName)}
                      </span>
                    </div>
            ...
            <div className="mt-6 bg-custom-blue/5 p-4 rounded-lg mb-5">
              ...
              <div className="space-y-2 text-sm text-custom-blue/80">
                <p>
                  ...
                  {interviewer.contact.preferredDuration || 60} minutes
                </p>
  ...
  return (
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[60]">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-4xl max-h-[95vh] overflow-hidden m-6">
        <div className=" border-b border-gray-200 px-4 py-3">
          <div className="flex items-center justify-between">
            <div className="flex flex-row sm:flex-col md:flex-col lg:items-center xl:items-center 2xl:items-center">
              <div className="flex items-center gap-4">
                <InterviewerAvatar interviewer={interviewer} size="lg" />
                <div>
                  <div className="flex sm:flex-col md:flex-col lg:items-center xl:items-center 2xl:items-center gap-2 mb-2">
                    <h2 className="sm:text-md md:text-md lg:text-xl xl:text-xl 2xl:text-xl font-semibold text-gray-900">
                      {capitalizeFirstLetter(interviewer.contact.firstName) +
                        " " +
                        capitalizeFirstLetter(interviewer.contact.lastName)}
                    </h2>
                    <p className="text-sm text-gray-500 truncate min-w-0 max-w-[300px]">
                      {capitalizeFirstLetter(interviewer.professionalTitle)}
                    </p>
                  </div>
                    ...
                    {interviewer?.interviewerType && (
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm font-medium text-gray-700">
                          {capitalizeFirstLetter(interviewer?.interviewerType)}{" "}
                          Interviewer
                        </span>
                      </div>
                    )}
          ...
          <nav className="flex space-x-8 px-4" role="tablist">
            ...
            >
              <div className="flex items-center">
                ...
                <span
                  className={activeTab === "about" ? "text-custom-blue" : ""}
                >
                  About
                </span>
              </div>
            ...
            >
              <div className="flex items-center">
                ...
                <span
                  className={
                    activeTab === "availability" ? "text-custom-blue" : ""
                  }
                >
                  Availability
                </span>
