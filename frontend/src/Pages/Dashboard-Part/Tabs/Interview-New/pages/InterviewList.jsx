...
const InterviewList = ({ interviews, isPositionView }) => {
  ...
  const tableColumns = getInterviewColumns(navigate, effectivePermissions, {
    onViewPosition: handleViewPosition
  });

  // Table Actions Configuration
  const tableActions = getInterviewActions(navigate, effectivePermissions, {
        ...
        <main className="px-6">
          <div className="sm:px-0">
            ...
            <Toolbar
              ...
              searchPlaceholder="Search by Interview Id, Candidate Name, Position..."
