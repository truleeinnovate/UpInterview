...
import { X, User, FileText, Mail, Phone, Clock, MapPin, Building, ChevronDown, ChevronUp } from 'lucide-react';
...
function EntityDetailsModal({ 
          ...
          <div className="space-y-6">
            ...
            <div className="bg-secondary/50 p-4 rounded-md border border-border">
              ...
              <div className="flex items-center">
                ...
                <span className="text-foreground">{candidate.experience} years</span>
              </div>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-secondary/50 p-4 rounded-md border border-border">
              ...
              <p className="text-muted-foreground">
                This is a {position.title} position in the {position.department} department, 
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 overflow-y-auto">
      <motion.div 
        ref={modalRef} 
        className="bg-card w-full md:w-1/2 max-h-[90vh] shadow-xl rounded-lg p-6 overflow-y-auto glass-sidebar"
