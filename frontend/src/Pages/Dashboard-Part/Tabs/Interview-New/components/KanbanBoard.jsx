...
// v1.0.1 - Ashok - Added full Kanban actions menu (same as Candidate page)
// v1.0.1 - Ashok - Added kanban actions support
...
//   // Helper to get visible actions for a specific interview
//   const getActionsForInterview = (interview) => {
//     return kanbanActions.filter((action) => {
