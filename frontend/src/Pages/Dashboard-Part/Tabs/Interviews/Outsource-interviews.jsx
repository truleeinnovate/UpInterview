...
const Outsource = ({ objectPermissions, sharingPermissions }) => {
  ...
  useEffect(() => {
    const ws = handleWebSocket("interview", setNotification);
    ...
    ws.onmessage = (event) => {
      ...
      if (type === "newInterview") {
        ...
        setNotification(
          "A new Outsource Interview has been created successfully!"
        );
    ...
    <>
      ...
      <div className="fixed top-24 left-0 right-0 z-30">
        <div className="flex justify-between p-4">
          <div>
            <span className="text-lg font-semibold">Outsource Interviews</span>
          </div>
          ...
          <div className="relative z-50">
            {objectPermissions.Create && (
              <span
                className="p-2 bg-custom-blue text-md sm:text-sm md:text-sm text-white font-semibold border shadow rounded cursor-pointer"
