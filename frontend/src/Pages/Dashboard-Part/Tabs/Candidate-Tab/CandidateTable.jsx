...
//   return (
//     <div className={`w-full ${isAssessmentView ? 'min-w-7 ' : 'h-[calc(100vh-12rem)]'} flex flex-col`}>

//       <div className="hidden lg:flex xl:flex 2xl:flex flex-col flex-1">
//         {/* <div className="overflow-x-auto"> */}
//         <div className={isAssessmentView ? "" : "inline-block min-w-full align-middle"}>
//           <div
//             className={isAssessmentView ? "" : "h-[calc(100vh-12rem)] overflow-y-auto pb-6"}
...
//                                       onClick={() => navigate(
//                                         isAssessmentView
//                                           ? `candidate-details/${candidate._id}`
//                                           : `view-details/${candidate._id}`,
//                                         {
//                                           state: isAssessmentView
//                                             ? {
//                                               from: `/assessment-details/${candidate?.assessmentId}`,
