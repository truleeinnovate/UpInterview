...
Feedback: ${round.feedback || "N/A"}
  ...
  return (
    ...
    <div className="fixed inset-0 z-50 bg-black bg-opacity-50">
      <div className="fixed inset-y-0 right-0 w-full md:w-1/2 lg:w-1/2 xl:w-1/2 2xl:w-1/2 bg-white shadow-2xl transform transition-transform duration-300 z-50 overflow-y-auto">
        {/* v1.0.0 <---------------------------------------------- */}
                ...
                <div className="p-4">
                  ...
                  <div className="mt-10 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 2xl:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        {["System design", "Performance optimization"].map(
                          (area, i) => (
                            <div
                              key={i}
                              className="flex items-center gap-2 text-sm text-gray-600"
                  ...
                  <div className="bg-blue-50 p-3 rounded-lg text-center mt-10">
                    ...
                    <p className="text-sm text-blue-700">
                      Candidate showed strong problem-solving skills and good
                      communication. Could improve on system design patterns and
        ...
        >
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setEditFormData({ ...editFormData, round: e.target.value })
                  }
            ...
            <div className="flex justify-end gap-3 pt-4">
              <button
                onClick={() => setIsEditModalOpen(false)}
                className="px-4 py-2 text-custom-blue rounded-lg border border-custom-blue transition-colors"
              >
                Cancel
              </button>
              <button
