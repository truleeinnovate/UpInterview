          ...
          <div className="flex items-center mb-6">
            ...
            >
              <div className="relative">
                ...
                <div
                  className={`absolute w-5 h-5 rounded-full shadow transition ${
                    notifyUser
                      ? "transform translate-x-full bg-custom-blue"
                      : "bg-white"
                  } top-0 left-0`}
                ></div>
              </div>
              <div className="ml-3 text-gray-700 font-medium">Notify User</div>
            </label>
          </div>
        </div>
