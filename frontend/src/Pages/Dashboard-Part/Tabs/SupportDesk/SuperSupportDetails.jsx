...
function SupportDetails() {
  ...
  const [selectedOwner, setSelectedOwner] = useState(currentTicket?.assignedTo || '');
  const [selectedOwnerId, setSelectedOwnerId] = useState(currentTicket?.assignedToId || '');
  ...
  const handleStatusUpdate = useCallback((updatedTicket) => {
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 2xl:grid-cols-2 gap-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">{currentTicket.contact || 'N/A'}</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <div className="p-2 bg-custom-blue/10 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">{currentTicket.organization || 'N/A'}</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <div className="p-2 bg-custom-blue/10 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">{currentTicket.issueType || 'N/A'}</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <div className="p-2 bg-custom-blue/10 rounded-lg">
