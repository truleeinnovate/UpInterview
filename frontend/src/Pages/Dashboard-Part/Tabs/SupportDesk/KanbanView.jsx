  ...
  if (loading) {
    return (
      ...
      >
        ...
        <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-4 gap-5 w-full">
          {[...Array(6)].map((_, index) => (
            <motion.div
              key={index}
    ...
    >
      <div className="h-full w-full">
        ...
        >
          ...
          <motion.span className="px-3 py-1.5 bg-white rounded-lg text-sm font-medium text-gray-600 shadow-sm border border-gray-200">
            {tickets?.length} Tickets
          </motion.span>
        </motion.div>
        {/*<-----v1.0.0----- */}
        <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-4 gap-5 w-full pb-16">
          {/*----v1.0.0-----> */}
          {currentTickets.length === 0 ? (
            <div className="col-span-full flex flex-col items-center justify-center py-16 text-gray-500">
              ...
              <p className="text-gray-500 text-center max-w-md">
                There are no tickets to display at the moment. Create a new
            ...
            currentTickets.map((ticket, index) => (
              <motion.div
                ...
                className={`bg-white rounded-xl p-5 shadow-sm border border-gray-200 hover:shadow-md transition-shadow duration-200 flex flex-col h-full ${
                  index >= currentTickets.length - 5 ? "mb-2" : ""
                }`}
              >
                <div className="flex justify-between items-start mb-4 gap-2">
                  {/*<------v1.0.0-------- */}
                  ...
                  >
                    <h4
                      className="text-xl font-medium text-custom-blue truncate mb-1"
                      onClick={() =>
                        navigate(
                          effectiveRole === "Admin" ||
                            effectivePermissions_RoleName ===
                            ...
                            : impersonatedUser_roleName === "Support_Team" &&
                              ticket.assignedToId === impersonationPayloadID
                            ? `/support-desk/view/${ticket._id}`
                      ...
                      <>
                        ...
                        {(effectiveRole === "Admin" ||
                          ...
                          <motion.button
                            ...
                            onClick={() =>
                              navigate(
                                `/support-desk/edit-ticket/${ticket._id}`,
                                {
                                  state: { ticketData: ticket },
                                }
                              )
                ...
                <div className="grid grid-cols-1 gap-2 text-sm">
                  <div className="grid grid-cols-1 gap-2">
                    <div className="grid grid-cols-2 text-gray-600 gap-2">
                  ...
                  <div className="grid grid-cols-1 gap-2">
                    ...
                    </div>
                    {
                      <div className="grid grid-cols-2 items-center">
                        ...
                        <span
                          className={`justify-self-start text-gray-800 font-medium px-2 py-1 text-xs leading-5 rounded-full ${getPriorityColor(
                            ticket.priority
                          )}`}
                        >
                          {ticket.priority || "N/A"}
