...
const Sidebar = React.lazy(() => import("../Assessment-Tab/NewAssessment.jsx"));
const EditAssessment = React.lazy(() => import("./EditAssessment.jsx"));
const ShareAssessment = React.lazy(() => import("./ShareAssessment.jsx"));
const AssessmentProfileDetails = React.lazy(() => import("./Assessmentprofiledetails.jsx"));
  ...
  return (
    <ErrorBoundary>
      <div>
        ...
        {selectedAssessment && (
          <Suspense fallback={<div>Loading EditAssessment...</div>}>
            <EditAssessment
        ...
        {isShareOpen && (
          <Suspense fallback={<div>Loading ShareAssessment...</div>}>
            <ShareAssessment
              isOpen={isShareOpen}
        ...
        {showAssessmentDetails && (
          <Suspense fallback={<div>Loading AssessmentProfileDetails...</div>}>
