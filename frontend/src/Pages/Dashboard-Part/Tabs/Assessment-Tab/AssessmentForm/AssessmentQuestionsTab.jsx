  ...
  return (
    ...
    <>
      ...
      {isQuestionPopup && selectedSection && (
        <div
          className="fixed inset-0 bg-red-800 bg-opacity-70 flex justify-center items-center z-50 min-h-screen"
          onClick={() => setIsQuestionPopup(false)}
        >
          <div
            className="bg-white rounded-lg w-[96%] max-h-[90vh] overflow-y-auto p-4"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="py-3 px-4  flex items-center justify-between">
