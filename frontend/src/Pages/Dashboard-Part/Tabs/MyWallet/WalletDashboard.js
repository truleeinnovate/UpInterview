                  ...
                  {filteredTransactions.map((tx, index) => (
                    ...
                    >
                      <div className="flex items-center gap-2 w-2/6">
                        ...
                        >
                          {tx.type === 'credited' && <ArrowUp className="text-[#217989] text-xs" />}
                          {tx.type === 'debited' && <ArrowDown className="text-green-500 text-xs" />}
                          {tx.type === 'Hold' && (
                      ...
                      <div>
                        <div
                          className={`text-lg w-1/5 ${tx.type === 'credited' ? 'text-green-500'
                            : tx.type === 'debited'
                              ? 'text-red-500'
                              : 'text-gray-500'
