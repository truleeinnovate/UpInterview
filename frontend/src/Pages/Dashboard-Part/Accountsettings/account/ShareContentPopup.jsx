            ...
            <div>
              ...
              <div className="flex space-x-2 mb-4">
                <input
                  ...
                  className="flex-1 rounded-md border-gray-300 shadow-sm focus:border-custom-blue focus:ring-custom-blue"
                />
                <select
                  value={formData.role}
                  onChange={(e) => setFormData(prev => ({ ...prev, role: e.target.value }))}
                  className="rounded-md border-gray-300 shadow-sm focus:border-custom-blue focus:ring-custom-blue"
                >
