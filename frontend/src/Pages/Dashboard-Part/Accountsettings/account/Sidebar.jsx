...
const SidebarProfile = ({isSidebarOpen,toggleSidebar, handleTabChange, activeTab, filteredNavigation}) => {
  ...
  return (
      <>
            {/* Mobile menu button */}
            <div className="lg:hidden xl:hidden 2xl:hidden  fixed top-20 left-0 right-0 z-20 bg-white border-b px-4 py-3">
              <button
        ...
        <div className={`
            ...
            lg:shadow-lg sm:mt-8 md:mt-8
            transition-transform duration-300 ease-in-out
            ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'}
          `}>
            <div className="flex flex-col h-screen">
              <div className="p-6 mt-12 lg:mt-0 xl:mt-0  2xl:mt-0">
