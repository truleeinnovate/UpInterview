...
import { Plus, Trash, Search, User } from "lucid-react";
            ...
            <div className="space-y-6">
              <div className="grid px-2 sm:grid-cols-1 grid-cols-2 gap-4 sm:gap-8">
                <div className="flex flex-col">
                  ...
                  <h2 className="w-full text-md text-gray-600 font-semibold">
                    {formData.roundName}
                  </h2>
                </div>

                <div className="flex px-2 flex-col">
                  <h1 className="text-gray-400 text-md pb-4">
                    Interview Type{" "}
                  </h1>
                  <h2 className="w-full text-md text-gray-600 font-semibold">
                    {formData.interviewType}
                ...
                <div className="grid sm:grid-cols-1 grid-cols-2 gap-4 sm:gap-8">
                  <div className="flex flex-col">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleInputChange("roundName", e.target.value)
                      }
...
const TechnicalType = ({
  ...
  useEffect(() => {
    if (roundDetails) {
      const initialData = {
        ...
        selectedInterviewerIds:
          roundDetails.interviewers?.map((interviewer) => ({
  ...
  const removeInterviewer = (index) => {
    const newInterviewers = formData.selectedInterviewers.filter(
      (_, i) => i !== index
    );
    const newInterviewerIds = formData.selectedInterviewerIds.filter(
      (_, i) => i !== index
    );
    setFormData((prev) => ({
      ...prev,
  ...
  const handleInterviewerSelect = (item) => {
    ...
    if (formData.selectedInterviewersType === "Individual") {
      ...
      const usernames = item.usersNames
        .split(",")
        .map((name) => name.trim())
        .slice(0, 5);
  ...
  const handleSave = () => {
    ...
    const dataForBackend = {
      ...formData,
      interviewers:
        formData.selectedInterviewerIds?.map((interviewer) => ({
          interviewerId: interviewer.interviewerId,
          interviewerName: interviewer.interviewerName,
        })) || [],
            ...
            <div className="space-y-6 px-2">
              ...
              <div className="grid grid-cols-1">
                <h1
                  ...
                  hidden={formData.interviewerType === "Outsourced Interviewer"}
                >
                  Interviewers
                </h1>
              </div>
              <div className="grid sm:grid-cols-1 md:grid-cols-3 grid-cols-4 gap-4">
                {formData.selectedInterviewers.map((interviewer, index) => (
                  <div
                    key={index}
                    className="border rounded px-2 py-2 relative"
                  >
              ...
              <div className="grid sm:grid-cols-1 grid-cols-2 gap-4 sm:gap-8">
                <div className="flex flex-col">
                  <h1 className="text-gray-400 text-md pb-4">
                    Minimum Interviewers Required
                  </h1>
                  <h2 className="w-full text-md text-gray-600 font-semibold px-3">
                    {formData.minimumInterviewers}
                  </h2>
                </div>
              </div>
          ...
          <div className="w-full border rounded-lg">
            ...
            <div className="flex justify-start items-center">
              ...
              <div className="space-y-6">
                  ...
                  <div className="flex flex-col">
                    ...
                    <div className="border rounded px-2">
                      <select
                        ...
                        onChange={(e) =>
                          handleInputChange("interviewerType", e.target.value)
                        }
                      ...
                      >
                        ...
                        <option value="Internal Interviewer">
                          Internal Interviewer
                        </option>
                        <option value="Outsourced Interviewer">
                ...
                <div className="grid sm:grid-cols-1 grid-cols-2 gap-4 sm:gap-8">
                  <div className="flex flex-col">
                    <label className="text-sm mb-2">Interviewers</label>
                    <div className="flex gap-2">
                      <div
                        className={`border w-28 rounded px-2 ${
                          formData.interviewerType === "Outsourced Interviewer"
                      ...
                      >
                        <select
                          ...
                          className={`w-full py-1.5 focus:outline-none focus:border-teal-500 ${
                            formData.interviewerType ===
                            "Outsourced Interviewer"
                              ? "bg-gray-100 cursor-not-allowed"
                              : "bg-white"
                      ...
                      <div className="relative flex-1">
                        ...
                        {showDropdown &&
                          formData.selectedInterviewersType &&
                          formData.interviewerType !==
                            "Outsourced Interviewer" && (
                            <div className="absolute z-10 w-full mt-1 bg-white border border-gray-300 rounded-md shadow-lg max-h-48 overflow-y-auto">
                              {loading ? (
                                ...
                                groups.length > 0 ? (
                                  groups.map((group, index) => (
                                    <div
                                      ...
                                      onClick={() =>
                                        handleInterviewerSelect(group)
                                      }
                                    >
                                      <span>{group.name}</span>
                                      <span className="text-gray-500 text-sm">
                                        ({group.numberOfUsers} users)
                                      </span>
                                    </div>
                                  ))
                                ) : (
                                ...
                                <div className="px-3 py-2 text-gray-500">
                                  Please select an interviewer type
                                </div>
                              )}
                            </div>
                          )}
                  ...
                  <div className="flex flex-col">
                    ...
                    <div className="flex border rounded">
                      <input
                        ...
                        min={
                          formData.selectedInterviewers.length === 0
                            ? 1
                            : formData.selectedInterviewers.length
                        }
                        max="5"
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  {questions.map((question, index) => (
                    <div
                      key={index}
                      className="flex gap-3 w-full p-4 bg-gray-50 rounded-md"
                    >
...
const TemplateModal = ({
  ...
  useEffect(() => {
    const isValid = templateTitle.trim() !== "" && label.trim() !== "";
  ...
  const isModalValid = useMemo(() => {
    if (isRoundModalOpen) {
      return templateTitle.trim() !== "" && label.trim() !== "" && isFormValid;
    }
    return templateTitle.trim() !== "" && label.trim() !== "";
  }, [templateTitle, label, isFormValid, isRoundModalOpen]);
      ...
      rounds: rounds.map((round) => {
        ...
        if (round.interviewType === "Technical") {
          ...
          roundData.selectedInterviewersType =
            round.selectedInterviewersType || "";
          ...
          if (
            round.selectedInterviewerIds &&
            round.selectedInterviewerIds.length > 0
          ) {
            roundData.interviewers = round.selectedInterviewerIds.map(
              (interviewer) => ({
                interviewerId: interviewer.interviewerId,
                interviewerName: interviewer.interviewerName,
              })
  ...
  const handleRoundNext = (interviewType, roundData) => {
    ...
    if (insertIndex !== -1) {
      ...
      const processedRoundData = {
        ...roundData,
        interviewers:
          roundData.selectedInterviewerIds?.map((interviewer) => ({
            interviewerId: interviewer.interviewerId,
            interviewerName: interviewer.interviewerName,
          })) || [],
    ...
    updatedRounds.forEach((round, idx) => {
      round.roundName = round.roundName.replace(
        /Round \d+/,
        `Round ${idx + 1}`
      );
    });
    ...
    setCurrentRoundIndex(
      insertIndex !== -1 ? insertIndex : updatedRounds.length - 1
    );
    setShowAssessment(true);
    setIsRoundModalOpen(false);
    setCurrentStage(
      `round${insertIndex !== -1 ? insertIndex + 1 : updatedRounds.length}`
    );
    setInsertIndex(-1);
    setRoundFormData({
      roundName: "",
  ...
  const renderStageIndicator = () => {
    ...
    const currentRoundNumber = currentStage.startsWith("round")
      ? parseInt(currentStage.slice(5))
      : 0;
      ...
      <div className="flex items-center justify-center mb-6 w-full overflow-x-auto py-2">
        <div className="flex items-center min-w-fit px-2">
          ...
          <div className="flex items-center">
            <span
              className={`whitespace-nowrap px-3 py-1.5 rounded text-sm font-medium ${
                isBasicStage
                      ...
                      <span
                        className={`whitespace-nowrap px-3 py-1.5 rounded text-sm font-medium ${
                          currentStage === "round" + (index + 1)
                            ? "bg-orange-500 text-white"
                            : currentStage.startsWith("round") &&
                              parseInt(currentStage.slice(5)) > index + 1
                            ? "bg-teal-600 text-white"
      ...
      {isViewMode ? (
        <div className="py-3 flex items-center justify-center ">
          <div className="container mx-auto max-w-full sm:px-6 md:px-20 px-40 sm:py-3 py-6 bg-white rounded-lg">
            ...
            {showAssessment ? (
              <div className="flex-grow">{renderInterviewComponent()}</div>
            ) : (
              <>
                {/* Modal Body */}
                <div className="">
                  ...
                  <div className="bg-white pt-4">
                    <div className="flex justify-end ">
                      <button
                        onClick={() =>
                          handleNextRoundClick(currentRoundIndex + 1)
                        }
                        className={`px-4 py-2 text-white rounded ${
                ...
                <div className="">
                  <div className="space-y-6 sm:px-6 sm:py-2 md:px-8 md:py-3 px-8 py-3 rounded-lg border">
                    <div className="grid md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 2xl:grid-cols-2 sm:grid-cols-1 sm:gap-2 md:gap-3 gap-4">
                      <div className="flex flex-col flex-grow">
                        <label className="text-sm whitespace-nowrap mb-2">
                ...
                <div className="bg-white rounded-lg sm:w-[300px] md:w-[400px] w-[500px] border-2">
                  ...
                  <div className="flex justify-end gap-3 p-4">
                    ...
                    <button
                      onClick={() => {
                        if (
                          roundFormData.roundName &&
                          roundFormData.interviewType
                        ) {
                          handleRoundNext(roundFormData.interviewType, {
                            ...roundFormData,
                            roundName: roundFormData.roundName.replace(
                              /Round \d+/,
                              `Round ${insertIndex + 1}`
                            ),
                          });
                      ...
                      disabled={
                        !roundFormData.roundName || !roundFormData.interviewType
                      }
                    >
                      Next
                    </button>
              ...
              <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                <div className="bg-white rounded-lg border p-6 w-[400px]">
                  <h3 className="text-lg font-semibold">
                    Delete Round {deleteConfirmation.roundIndex + 1}?
                  </h3>
                  <p className="text-gray-600 mb-6">
                    Are you sure you want to delete this round? This action
                    cannot be undone.
                  </p>
