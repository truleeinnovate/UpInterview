  ...
  const tableColumns = [
    {
      ...
      render: (value, row) => {
        ...
        return (
          <div
            className="truncate max-w-[160px] text-sm font-medium text-custom-blue cursor-pointer"
            onClick={() => handleView(row)}
          >
            {formattedValue} aaaaaaaaaaaaaaaaaaaaaaaa
          </div>
        );
      },
    },
    {
      ...
      render: (value) => {
        ...
        return (
          <span className="truncate max-w-[140px] block" title={displayValue}>
            {displayValue}
          </span>
        );
      },
    },
    {
      ...
      render: (value) => {
        if (!Array.isArray(value) || value.length === 0) {
          ...
          return (
            <span className="truncate max-w-[140px] block" title={noRounds}>
              {noRounds}
            </span>
          );
        }
        ...
        return (
          <span className="truncate max-w-[140px] block" title={fullText}>
            {fullRounds}
          </span>
        );
      },
    ...
    },
    {
      ...
      render: (value) => {
        ...
        return (
          <span className="whitespace-nowrap truncate max-w-[140px] block">
            {formatLabel}
          </span>
        );
      },
