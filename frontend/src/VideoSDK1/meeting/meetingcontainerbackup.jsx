...
export function MeetingContainer({
  ...
  // const isCandidate = meetingData?.isCandidate === true;
  // const isInterviewer = meetingData?.isInterviewer === true;
...
//   return navigationItems.filter(item => item.show === true);
// };
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 flex overflow-hidden">
          ...
          >
            ...
            {!mMeeting.isMeetingJoined && !mMeeting.localParticipant?.allowJoin && <WaitingToJoinScreen />}
          </div>
