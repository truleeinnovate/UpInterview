...
// // MeetingContainer.js (Updated with PiP participant strip on right during screen share - incorporates all previous changes)
...
//   // NEW: Participant PiP Strip Component (for right-side during presentation)
//   const ParticipantPiPStrip = ({ participantIds, height }) => {
//     if (participantIds.length === 0) return null;

//     const numParticipants = participantIds.length;
//     const isOneParticipant = numParticipants === 1;
//     const gridCols = isOneParticipant ? 'grid-cols-1' : 'grid-cols-2'; // 1: single column; 2+: 2 cols
//     const gridRows = isOneParticipant ? 'grid-rows-1' : `grid-rows-${Math.ceil(numParticipants / 2)}`;

//     return (
//       <div className="w-full h-full bg-gray-800 border-l border-gray-600 p-2 flex flex-col">
//         <div className="text-xs text-gray-400 mb-2 text-center">Participants</div>
//         <div 
//           className={`grid ${gridCols} ${gridRows} gap-2 flex-1 justify-items-center items-center`}
//           style={{ 
//             gridTemplateColumns: isOneParticipant ? '1fr' : '1fr 1fr',
//             gridAutoRows: '1fr'
//           }}
//         >
...
//               style={{ 
//                 height: `calc(100% / ${Math.max(1, Math.ceil(numParticipants / (isOneParticipant ? 1 : 2)))})`,
//                 minHeight: '100px'
//               }}
//             >
...
//                     {console.log('ispresenting in bottom code:', isPresenting)}
//                     {isPresenting ? (
