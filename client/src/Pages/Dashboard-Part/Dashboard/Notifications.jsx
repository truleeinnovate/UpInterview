  ...
  return (
    <>
      <div className="container mx-auto mt-5 flex">
        <div
          className={`flex-grow transition-all duration-300 ${isMenuOpen ? "mr-72" : ""
            }`}
        >
                ...
                <div className="flex justify-between p-4">
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="flex">
                      ...
                      >
                        <span
                          className={`border-2 p-2 mr-2 ${currentPage === 0
                      ...
                      >
                        <span
                          className={`border-2 p-2 ${currentPage >=
                              Math.ceil(
              ...
              <div className="flex flex-col text-sm w-full overflow-y-scroll max-h-[420px]">
                {filteredNotifications
                  ...
                  .map((notification, index) => (
                    <div key={index} className="flex justify-between items-start mx-7 my-4">
                      <div className="flex items-start">
                        ...
                        <div className="ml-4">
                          ...
                          <p className="mb-2">{new Date(notification.createdAt).toLocaleString()}</p>
                        </div>
                      </div>
