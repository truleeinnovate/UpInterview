...
const Profile_Edit_Form = ({ onClose, profileData }) => {
  ...
  const handleTabChange = (index, value) => {
    ...
    updatedTabs[index] = { name: tabsData[index], status: value || 'Hidden' }; // Default to 'Hidden' if not selected
    setFormData({
      ...formData,
      Tabs: updatedTabs
    });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.put(`${process.env.REACT_APP_API_URL}/api/profiles/${profileData._id}`, formData);
                      ...
                      <tr key={index} className="border-b">
                        ...
                        <td className="py-2">
                          <select
                            ...
                            value={formData.Tabs[index]?.status || ''}
                    ...
                    {objectsData.map((object, index) => (
                      <tr key={index} className="border-b">
                        ...
                        <td className="py-2 border-r text-center">
                          <input
                            type="checkbox"
                            checked={formData.Objects[index]?.permissions?.view || false}
                        ...
                        <td className="py-2 border-r text-center">
                          <input
                            type="checkbox"
                            checked={formData.Objects[index]?.permissions?.Create || false}
                        ...
                        <td className="py-2 border-r text-center">
                          <input
                            type="checkbox"
                            checked={formData.Objects[index]?.permissions?.Edit || false}
                        ...
                        <td className="py-2 text-center">
                          <input
                            type="checkbox"
                            checked={formData.Objects[index]?.permissions?.Delete || false}
