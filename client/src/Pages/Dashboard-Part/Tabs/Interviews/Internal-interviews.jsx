...
const Internal = () => {
  ...
  const FilteredData = () => {
    ...
    return interviewData.filter((user, index) => {
      ...
      // const isInternalInterview = user.Interviewstype === "/internalinterview";

      const matchFound = fieldsToSearch.some((field) => {
        const fieldExists = field !== undefined;
        const containsQuery = fieldExists && field.toString().toLowerCase().includes(searchQuery.toLowerCase());
  ...
  const handleUpdate = (interviewId, scheduleType) => {
    ...
    setSelectedCandidate(
      interviewData.find((candidate) => candidate._id === interviewId)
    );
  };
  ...
  //       setInterviewData((prevData) => [...prevData, data]);
  ...
  return (
    <>
      {!isScheduleLaterOpen && !selectedCandidate && (
        <>
          {/* 1 */}
            ...
            <div className="flex justify-between p-4">
              ...
              >
                {objectPermissions.Create && (
                  <span className="p-2 bg-custom-blue text-md sm:text-sm md:text-sm text-white font-semibold border shadow rounded cursor-pointer">
                    New
                  </span>
                )}
                ...
                {interviewDropdown && (
                  <div className="absolute mt-5 right-0 z-50 w-48 rounded-md shadow-lg bg-white ring-1 p-2 ring-black ring-opacity-5">
                    <div className="space-y-1">
                      <p
                        className="block px-4 py-1 hover:bg-gray-200 hover:text-gray-800 rounded-md cursor-pointer"
                        onClick={() => {
                          setinterviewDropdown(false);
                          openScheduleLater("ScheduleLater");
                        }}
                      >
                        Schedule for Later
                      </p>
                              ...
                              {loading ? (
                                ...
                                currentFilteredRows.map((interview) => (
                                  ...
                                  >
                                      ...
                                      <div className="flex items-center">
                                        ...
                                        {interview.Status === "ScheduleCancel" && (
                                          <>
                                            ...
                                            >
                                              <span>
                                              <MdOutlineCancel style={{ fill: "red", width: "24px", height: "24px" }} />
                                              </span>
                                            </Tooltip>
                                          </>
                                        )}
                                    ...
                                    <td className="py-2 px-6">
                                      {new Date(interview.createdOn).toLocaleString('en-In', {
                                        year: 'numeric',
                                        month: 'short',
                                        day: '2-digit',
                                        hour: '2-digit',
                                    ...
                                    <td className="py-2 px-6">
                                      <div>
                                        ...
                                        {actionViewMore === interview._id && (
                                          <div className="absolute z-10 w-28 rounded-md shadow-lg bg-white ring-1 p-2 ring-black ring-opacity-5 right-14">
                                            <div className="space-y-1">
                                  ...
                                  <div className="absolute right-1 bottom-1 ">
                                    ...
                                    {interview.Status === "ScheduleCancel" && (
                                      <>
                                        ...
                                        >
                                          <span>
                                            <MdOutlineCancel className="text-3xl ml-1 mr-1 text-red-500" />
                                          </span>
                                        </Tooltip>
                                      </>
                                    )}
