...
//   try {
//     const { invoiceId, transactionId, paymentMethod } = req.body;

//     // Update invoice to paid
//     const invoice = await Invoice.findByIdAndUpdate(invoiceId, {
//       status: 'paid',
//       paymentDetails: { transactionId, paymentMethod }
//     }, { new: true });
...
// router.post('/payment-success', customerSubscriptionController.paymentSuccess);
...
//     try {
//         const { tenantId, subscriptionPlanId, billingCycle } = req.body;
...
//         const selectedPricing = plan.pricing.find(p => p.billingCycle === billingCycle);
//         if (!selectedPricing) {
//             return res.status(400).json({ message: 'Invalid billing cycle' });
//         }

//         const totalAmount = selectedPricing.price - (selectedPricing.discount || 0);
...
//             startDate: Date.now(),
//             nextBillingDate: calculateNextBillingDate(Date.now(), billingCycle),
